/*          Eric Smrkovsky--CSci 172--Project4--Fall2021
...
void myLoader(bool debug, string filename) {
...
{
    string filename = "objFiles/cube.obj";
    //string filename = "objFiles/ateneam.obj";
    //string filename = "objFiles/ven.obj";
    //string filename = "objFiles/bunny.obj";
    myLoader(DEBUG, filename);   //debug on/off == true/false set at top of program
